...
from src.smtp.application.schemas import CreateSMTPRequest
...
class CreateUseCase:
    ...
    async def execute(self, *, smtp_request: CreateSMTPRequest) -> None:
        # TODO: your logic here
        await self.smtp_repository.create(data=smtp_request)
