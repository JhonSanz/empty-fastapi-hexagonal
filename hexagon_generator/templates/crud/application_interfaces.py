...
class {{ model_pascal_case }}ServiceInterface(ABC):
    \"""
    Interface defining the contract for {{ model_pascal_case }} application services.

    This interface establishes the public API that all {{ model_pascal_case }} service
